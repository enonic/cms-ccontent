...
import com.enonic.plugin.CopyContentController;
...
public class Helper {
    ...
    public static void writeJsonRespone(ResponseMessage responseMessage, HttpServletResponse response) throws IOException{
    ...
    public static void serveCss(String css, HttpServletResponse response) throws Exception {
        InputStream in = CopyContentController.class.getResourceAsStream(css);
